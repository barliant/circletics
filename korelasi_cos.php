...
function similarity_cos($user1, $user2){
...
$ID_User=$data['ID_User'];
 $u[$i]=$ID_User;
 $sim=similarity_cos($u1,$ID_User);
mysql_query("INSERT INTO hasilhitung_cos(ID_User, ID_User_Rekomendasi, korelasi) values  ($u1, '$ID_User', '$sim')");
